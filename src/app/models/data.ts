export class Data {
    ...
    public filters: Array<any>     = [ 'None', 'Gray', 'Brownie',  'Sepia', 'Invert'];                                   
    ...
    public color: Array<any> = ['rgb(0, 255, 255)', 'rgb(240, 255, 255)', 'rgb(245, 245, 220)','rgb(0, 0, 0)','rgb(0, 0, 255)',
    ...
    public stroke: Array<any> = this.color;
    public shadow: Array<any> = this.color;
